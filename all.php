...
<?php
		...
		echo "		<b>\n 			<center>\n				Total Points: $total_points &nbsp;|&nbsp; Total Contacts: $total_contacts &nbsp;|&nbsp; Total Phone Contacts: $total_phone &nbsp;|&nbsp; Total Digital Contacts: $total_digital &nbsp;|&nbsp; Total CW Contacts: $total_cw <br />\n";
		if (($win_c != NULL) && ($win_p != NULL))
			echo "				Most Contacts (".$stats_contacts[$win_c[0]]."):<img src=\"./img/m_c.png\"> &nbsp; &nbsp;|&nbsp; &nbsp; Most Points (".$stats_points[$win_p[0]]."):<img src=\"./img/m_p.png\">\n"; 
		echo "			</center>\n 		</b>\n 		<hr>";
?>
